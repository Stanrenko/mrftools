...
if __name__ == '__main__':
    ...
    parser_maps.add_argument('--dictfiles', type=str,nargs='?', const=DICT / "mrf_dictconf_Dico2_Invivo_TR1.11_reco5.0.pkl", default=DICT / "mrf_dictconf_Dico2_Invivo_TR1.11_reco5.0.pkl")
